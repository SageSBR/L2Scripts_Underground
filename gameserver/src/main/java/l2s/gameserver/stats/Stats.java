...
public enum Stats
{
	...
	M_CRITICAL_DAMAGE("mCritDamage", 0., Double.POSITIVE_INFINITY, 1.),
	...
	SKILL_CRIT_DAM_MOD("SkillCritDamMod", 0.1, 4., 1.),
	DEATH_VULNERABILITY("deathVuln", 10., 190., 100.),

	P_CRIT_DAMAGE_RECEPTIVE("pCritDamRcpt", Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY),
	...
	BLOCK_DAMAGE("blockDamage", 0., 100., 0.),
	...
	// @Rivelia. TODO.
	SPEED_ON_DEX_DEPENDENCE("p_skill_crit_rate_dex_dependence", 0., 1., 0.),
	...
	ABSORB_VULN("absorbResist", 1.,1., 1.),//done
	PK_PENALTY_CHANCE("pkPenaltyChance", 1., 1., 1.), // балванка
	VITALITY_CONSUME_RATE("vitalityConsumeRate", 1.,1.,1.),// балванка
	M_SKILL_POWER("mSkillPower", 1., 1., 1.),//done
	CRAFT_MASTERY("craftMastery",1.,1.,1.),//done
	SP_LOST("spLost",1.,1.,1.),//балванка
	P_FATAL_LETHAL_RESIST("p_fatal_lethal_resist",1.,1.,1.),//done
	P_PVE_PHYSICAL_ATTACK_DMG_BONUS_BOSS("p_pve_physical_attack_dmg_bonus_boss",1.,1.,1.),//done
	P_PVE_MAGICAL_SKILL_DMG_BONUS_BOSS("p_pve_magical_skill_dmg_bonus_boss",1.,1.,1.),//done
	P_PVE_PHYSICAL_SKILL_DMG_BONUS_BOSS("p_pve_physical_skill_dmg_bonus_boss",1.,1.,1.),//done
	EXIL_PROF("exilProf",1.,1.,1.), //балванка

	DAMAGE_BLOCK_RADIUS("damage_block_radius", 0., Double.POSITIVE_INFINITY, -1.);
