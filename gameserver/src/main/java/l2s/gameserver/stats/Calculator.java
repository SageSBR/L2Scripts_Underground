...
public final class Calculator
{
	...
	public List<CalculatedStats> getCalculatedStats(Creature _activeChar, double init)
	{
		List<CalculatedStats> modifiedStats = new LazyArrayList<CalculatedStats>();
		Env env = new Env();
		...
		{
			func.calc(env);
			modifiedStats.add(new CalculatedStats(func, env.value - base));
			base = env.value;
		}
