...
public class TriggerInfo extends Skill.AddedSkill
{
	...
	public TriggerInfo(int id, int level, TriggerType type, double chance, boolean increasing, int delay, boolean cancel)
	{
		super(id, level);
		_type = type;
		_chance = chance;
	...
	public boolean checkCondition(Creature actor, Creature target, Creature aimTarget, Skill owner, double damage)
	{
		...
		if(getSkill().checkTarget(actor, aimTarget, aimTarget, false, false, _type) != null)
			return false;
