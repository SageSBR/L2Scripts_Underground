...
public class SiegeUtils
{
	...
	{
		character.addSkill(SkillHolder.getInstance().getSkill(19034, 1), false); // Печать Света
		character.addSkill(SkillHolder.getInstance().getSkill(19035, 1), false); // Печать Тьмы
	...
	{
		character.removeSkill(SkillHolder.getInstance().getSkill(19034, 1), false); // Печать Света
		character.removeSkill(SkillHolder.getInstance().getSkill(19035, 1), false); // Печать Тьмы
