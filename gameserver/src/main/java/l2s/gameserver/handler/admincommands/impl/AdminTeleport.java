	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			case admin_show_moves:
				activeChar.sendPacket(new NpcHtmlMessagePacket(5).setFile("admin/teleports.htm"));
				break;
			case admin_show_moves_other:
				activeChar.sendPacket(new NpcHtmlMessagePacket(5).setFile("admin/tele/other.htm"));
				break;
