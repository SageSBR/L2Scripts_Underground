	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			case admin_show_spawns:
				activeChar.sendPacket(new NpcHtmlMessagePacket(5).setFile("admin/spawns.htm"));
				break;
			case admin_spawn_index:
				try
				{
					String val = fullString.substring(18);
					activeChar.sendPacket(new NpcHtmlMessagePacket(5).setFile("admin/spawns/" + val + ".htm"));
				}
