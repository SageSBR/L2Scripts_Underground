...
public final class ItemInstance extends GameObject implements JdbcEntity
{
	...
	private boolean _isTemporal = false;
	...
	public int getEnchantLevel(/*boolean withBase*/)
	{
		return enchantLevel/* + (withBase ? template.getBaseEnchantLevel() : 0)*/;
	}
	...
	{
		if(getVisualId() > 0 || isTemporalItem())
	...
	{
		return isHeroWeapon() || template.isHeroCloak();
	}
	...
	{
		return template.isShadowItem() && !isTemporalItem();
	}

	public void setTemporalItem(boolean tmp)
	{
		_isTemporal = tmp;
	}
	...
	{
		return _isTemporal || template.isTemporal();
	}
	...
	public int getCrystalCountOnEchant()
	{
		...
		{
			int crystalsAdd = ItemFunctions.getCrystallizeCrystalAdd(this);
			return (defaultCrystalCount / 2) + crystalsAdd;
		}
		return 0;
	}
