...
{
	private static final long MAX_DELAY_BETWEEN_DEATHS = 120000L;
	...
	public void onKilled(Creature actor, Creature victim)
	{
		...
		if (victim.isPlayer())
		{
			...
			leaveEvent(fVictim.getPlayer(), true, false);
	...
	{
		boolean result = super.leaveEvent(player, teleportTown, instant);
		if (result)
			checkRoundOver();
		return result;
	}
