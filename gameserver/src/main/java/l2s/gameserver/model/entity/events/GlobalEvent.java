...
public abstract class GlobalEvent extends LoggerObject
{
	...
	public boolean containsObjects(String name)
	{
	...
	{
		Iterator<Entry<ItemInstance>> iterator = _banishedItems.entrySet().iterator();
		while(iterator.hasNext())
		{
			Entry<ItemInstance> entry = iterator.next();
			iterator.remove();
	...
	public void cloneTo(GlobalEvent e)
	{
		...
		for(Entry<List<EventAction>> entry : _onTimeActions.entrySet())
