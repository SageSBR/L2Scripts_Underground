...
public enum ClassId
{
	...
	/*139*/SIGEL_KNIGHT(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.KNIGHT, null)
	{
		@Override
	...
	/*140*/TYR_WARRIOR(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.WARRIOR, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*141*/OTHELL_ROGUE(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ROGUE, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*142*/YR_ARCHER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ARCHER, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*143*/FEOH_WIZARD(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.WIZARD, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*144*/ISS_ENCHANTER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ENCHANTER, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*145*/WYNN_SUMMONER(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.SUMMONER, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*146*/EOLH_HEALER(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.HEALER, null)
	{
		@Override
		public ClassId getAwakeParent(ClassId classId)
		{
	...
	/*Sigel Knight*/
	/*148*/SIGEL_PHOENIX_KNIGHT(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.KNIGHT, SIGEL_KNIGHT)
	{
		@Override
	...
	/*149*/SIGEL_HELL_KNIGHT(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.KNIGHT, SIGEL_KNIGHT)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*150*/SIGEL_EVAS_TEMPLAR(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.KNIGHT, SIGEL_KNIGHT)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*151*/SIGEL_SHILLIEN_TEMPLAR(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.KNIGHT, SIGEL_KNIGHT)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Tyr Warrior*/
	/*152*/TYR_DUELIST(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.WARRIOR, TYR_WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*153*/TYR_DREADNOUGHT(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.WARRIOR, TYR_WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*154*/TYR_TITAN(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.WARRIOR, TYR_WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*155*/TYR_GRAND_KHAVATARI(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.WARRIOR, TYR_WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*156*/TYR_MAESTRO(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.WARRIOR, TYR_WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*157*/TYR_DOOMBRINGER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.WARRIOR, TYR_WARRIOR)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Othell Rogue*/
	/*158*/OTHELL_ADVENTURER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ROGUE, OTHELL_ROGUE)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*159*/OTHELL_WIND_RIDER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ROGUE, OTHELL_ROGUE)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*160*/OTHELL_GHOST_HUNTER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ROGUE, OTHELL_ROGUE)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*161*/OTHELL_FORTUNE_SEEKER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ROGUE, OTHELL_ROGUE)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Yr Archer*/
	/*162*/YR_SAGITTARIUS(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ARCHER, YR_ARCHER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*163*/YR_MOONLIGHT_SENTINEL(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ARCHER, YR_ARCHER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*164*/YR_GHOST_SENTINEL(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ARCHER, YR_ARCHER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*165*/YR_TRICKSTER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ARCHER, YR_ARCHER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Feoh Wizard*/
	/*166*/FEOH_ARCHMAGE(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.WIZARD, FEOH_WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*167*/FEOH_SOULTAKER(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.WIZARD, FEOH_WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*168*/FEOH_MYSTIC_MUSE(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.WIZARD, FEOH_WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*169*/FEOH_STORM_SCREAMER(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.WIZARD, FEOH_WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*170*/FEOH_SOUL_HOUND(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.WIZARD, FEOH_WIZARD)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Iss Enchanter*/
	/*171*/ISS_HIEROPHANT(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ENCHANTER, ISS_ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*172*/ISS_SWORD_MUSE(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ENCHANTER, ISS_ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*173*/ISS_SPECTRAL_DANCER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ENCHANTER, ISS_ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*174*/ISS_DOMINATOR(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ENCHANTER, ISS_ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*175*/ISS_DOOMCRYER(ClassType.FIGHTER, ClassLevel.AWAKED, ClassType2.ENCHANTER, ISS_ENCHANTER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Wynn Summoner*/
	/*176*/WYNN_ARCANA_LORD(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.SUMMONER, WYNN_SUMMONER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*177*/WYNN_ELEMENTAL_MASTER(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.SUMMONER, WYNN_SUMMONER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*178*/WYNN_SPECTRAL_MASTER(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.SUMMONER, WYNN_SUMMONER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*Aeore Healer*/
	/*179*/AEORE_CARDINAL(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.HEALER, EOLH_HEALER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*180*/AEORE_EVAS_SAINT(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.HEALER, EOLH_HEALER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
	...
	/*181*/AEORE_SHILLIEN_SAINT(ClassType.MYSTIC, ClassLevel.AWAKED, ClassType2.HEALER, EOLH_HEALER)
	{
		@Override
		public ClassId getBaseAwakeParent(ClassId classId)
		{
