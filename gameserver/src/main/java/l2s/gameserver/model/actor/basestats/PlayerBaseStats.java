...
public class PlayerBaseStats extends PlayableBaseStats
{
	...
	public double getHpMax()
	{
		...
		return Formulas.upplyCHABonus(getOwner(), maxHp);
	}
	...
	public double getMpMax()
	{
		...
		return Formulas.upplyCHABonus(getOwner(), maxMp);
	}
	...
	public double getCpMax()
	{
		...
		return Formulas.upplyCHABonus(getOwner(), maxCp);
	}
	...
	public double getPAtk()
	{
		...
		return Formulas.upplyCHABonus(getOwner(), pAtk);
	}
	...
	public double getMAtk()
	{
		...
		return Formulas.upplyCHABonus(getOwner(), mAtk);
	}
	...
	public double getPDef()
	{
		...
		return Formulas.upplyCHABonus(getOwner(), result);
	}
	...
	public double getPAtkSpd()
	{
		...
		return Formulas.upplyCHABonus(getOwner(), pAtkSpd);
	}
	...
	public double getMAtkSpd()
	{
		...
		return Formulas.upplyCHABonus(getOwner(), mAtkSpd);
	}
