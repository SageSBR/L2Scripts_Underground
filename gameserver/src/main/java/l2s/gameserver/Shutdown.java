		...
		public void run()
		{
			switch(shutdownCounter)
			{
				...
				case 5:
					...
					{
						Announcements.getInstance().announceToAll(new SystemMessagePacket(SystemMsg.THE_SERVER_WILL_BE_COMING_DOWN_IN_S1_SECONDS__PLEASE_FIND_A_SAFE_PLACE_TO_LOG_OUT).addInteger(shutdownCounter));
					}
					break;
				case 0:
					switch(shutdownMode)
