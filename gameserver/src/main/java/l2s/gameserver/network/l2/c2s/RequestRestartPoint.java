		...
		switch(_restartType)
		{
			...
			case FIXED:
				...
				else
				{
					...
					if(level <= 19 && ItemFunctions.removeItem(activeChar, 8515, 1, true) == 1)
					{
						activeChar.doRevive(100);
						return;
					}

					if(level <= 39 && ItemFunctions.removeItem(activeChar, 8516, 1, true) == 1)
					{
						activeChar.doRevive(100);
						return;
					}

					if(level <= 51 && ItemFunctions.removeItem(activeChar, 8517, 1, true) == 1)
					{
						activeChar.doRevive(100);
						return;
					}

					if(level <= 60 && ItemFunctions.removeItem(activeChar, 8518, 1, true) == 1)
					{
						activeChar.doRevive(100);
						return;
					}

					if(level <= 75 && ItemFunctions.removeItem(activeChar, 8519, 1, true) == 1)
					{
						activeChar.doRevive(100);
						return;
					}

					if(level <= 84 && ItemFunctions.removeItem(activeChar, 8520, 1, true) == 1)
					{
						activeChar.doRevive(100);
						return;
					}
