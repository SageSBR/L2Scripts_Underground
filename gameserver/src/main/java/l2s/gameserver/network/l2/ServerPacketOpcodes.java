...
public enum ServerPacketOpcodes
{
	...
	/*0xA7*/	TutorialShowQuestionMarkPacket,
	...
	/*0xFE*/	ExShuttuleInfoPacket(0xCB),
	...
	/*0xFE*/	ExPetInfo(0x15E), //PetInfoPacket
	...
	/*0xFE*/	ExReceiveClientINI(0x178),
	/*0xFE*/	ExAutoFishAvailable(0x179),
	/*0xFE*/	ExChannlChatEnterWorld(0x17A),
	/*0xFE*/	ExChannlChatPlegeInfo(0x17B),
	/*0xFE*/	ExVipAttendanceItemList(0x17C),
	/*0xFE*/	ExConfirmVipAttendanceCheck(0x17D),
	/*0xFE*/	ExShowEnsoulWindow(0x17E),
	/*0xFE*/	ExEnsoulResult(0x17F),
	/*0xFE*/	ReciveVipLuckyGameItemList(0x180),
	/*0xFE*/	ReciveVipLuckyGameResult(0x181),
	/*0xFE*/	ReciveVipInfo(0x181),
	/*0xFE*/	ReciveVipInfoRemainTime(0x182),
	/*0xFE*/	ReceiveVipBotCaptchaImage(0x183),
	/*0xFE*/	ReceiveVipBotCaptchaAnswerResult(0x184),
	/*0xFE*/	ExOneDayRewardList(0x188),
	/*0xFE*/	ExConnectedTimeAndGetTableReward(0x189);
