...
public class RequestPledgeRecruitBoardSearch extends L2GameClientPacket
{
	...
	{
		_params = new ClanSearchParams(readD(), ClanSearchListType.getType(readD()), ClanSearchTargetType.valueOf(readD()), readS(), ClanSearchClanSortType.valueOf(readD()), ClanSearchSortOrder.valueOf(readD()), readD());
	}
