...
public class RequestJoinPledgeByName extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(member == null)
		{
			FakePlayerInstance fakePlayer = GameObjectsStorage.getFakePlayerByName(_targetName);
			if(fakePlayer != null)
			{
				if(_pledgeType == Clan.SUBUNIT_ACADEMY && (fakePlayer.getLevel() >= 85 || fakePlayer.getClassId().isOfLevel(ClassLevel.AWAKED)))
				{
