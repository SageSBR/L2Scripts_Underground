...
public class ExResponseCommissionBuyInfo extends L2GameServerPacket
{
	...
	protected void writeImpl()
	{
		...
		writeH(_item.getItem().getType2()); //itemType2 or equipSlot
		writeQ(_item.getItem().getBodyPart()); //bodypart
		...
		writeD(_item.getEnchantOptions()[0]); //enchant_opt1
		writeD(_item.getEnchantOptions()[1]); //enchant_opt2
		writeD(_item.getEnchantOptions()[2]); //enchant_opt3
