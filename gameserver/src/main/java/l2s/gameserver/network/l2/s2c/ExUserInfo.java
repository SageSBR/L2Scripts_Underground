 ...
 * @reworked by Bonux
 */
public class ExUserInfo extends AbstractMaskPacket<UserInfoType>
{
	// Params
	...
	private final int _usedAbilitiesPoints;
	...
	public ExUserInfo(Player player, boolean addAll)
	{
	...
	protected final void writeImpl()
	{
		...
		if (!containsMask(UserInfoType.UNK_3))
			addComponentType(UserInfoType.UNK_3);
		...
		if(containsMask(UserInfoType.SLOTS))
		{
			...
			writeD(0x00); // (1 = Red, 2 = White, 3 = White Pink) dotted ring on the floor <- team mask
		}
