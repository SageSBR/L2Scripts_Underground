...
public final class WeaponTemplate extends ItemTemplate
{
	...
	{
		NONE(1, "Shield", Stats.FIST_WPN_VULNERABILITY),
		...
		ETC(7, "Etc", Stats.FIST_WPN_VULNERABILITY),
		...
		ROD(13, "Rod", Stats.FIST_WPN_VULNERABILITY),
	...
	public WeaponTemplate(StatsSet set)
	{
		...
		_atkReuse = set.getInteger("atk_reuse", _type == WeaponType.BOW ? 1500 : _type == WeaponType.CROSSBOW ? 820 : 0);
		...
		else if(_type == WeaponType.CROSSBOW)
