...
public class EnchantScroll
{
	...
	public EnchantScroll(int itemId, int variation, int maxEnchant, EnchantType type, ItemGrade grade, FailResultType resultType, boolean showFailEffect, int minEnchantStep, int maxEnchantStep)
	{
		_itemId = itemId;
