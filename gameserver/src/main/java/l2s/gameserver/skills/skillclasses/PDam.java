...
public class PDam extends Skill
{
	...
	protected void useSkill(Creature activeChar, Creature target, boolean reflected)
	{
		...
		if(_static)
		{
			realTarget.reduceCurrentHp(power, activeChar, this, true, true, _directHp, true, false, false, power != 0, true, false, false, false, false);
			return;
		}

		final AttackInfo info = Formulas.calcPhysDam(activeChar, realTarget, this, false, _blow, isSSPossible(), _onCrit);

		realTarget.reduceCurrentHp(info.damage, activeChar, this, true, true, _directHp, true, false, false, power != 0, true, info.crit || info.blow, false, false, false);
