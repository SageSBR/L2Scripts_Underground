...
public class Default extends Skill
{
	...
	public void onEndCast(Creature activeChar, List<Creature> targets)
	{
		...
		if(activeChar.isPlayer())
			activeChar.sendMessage(new CustomMessage("l2s.gameserver.skills.skillclasses.Default.NotImplemented", activeChar.getPlayer()).addNumber(getId()).addString("" + getSkillType()));
