...
public class Ride extends Skill
{
	...
	public boolean checkCondition(Creature activeChar, Creature target, boolean forceUse, boolean dontMove, boolean first)
	{
		...
		if(getNpcId() != 0)
		{
			...
			if(player.isInDuel() || player.isSitting() || player.isInCombat() || player.isFishing() || player.isCursedWeaponEquipped() || player.isTransformed() || player.getPet() != null || player.isMounted() || player.isInBoat())
			{
