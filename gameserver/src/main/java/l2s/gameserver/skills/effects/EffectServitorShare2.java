 ...
 * @author G1ta0
 */
public class EffectServitorShare2 extends Effect
{
	public class FuncShare2 extends Func
	{
		public FuncShare2(Stats stat, int order, Object owner, double value)
		{
	...
	public EffectServitorShare2(Env env, EffectTemplate template)
	{
		super(env, template);
	}
	...
	public Func[] getStatFuncs()
	{
		...
		if(_effected.isSummon())
		{
			...
			{
				funcs[i] = new FuncShare2(funcTemplates[i]._stat, funcTemplates[i]._order, this, funcTemplates[i]._value);
			}
		}
		return funcs;
	}
