...
public class AuthRequest extends ReceivablePacket
{
	...
	protected void runImpl()
	{
		...
		for(HostInfo host : _hosts)
		{
			...
			{
				sendPacket(new LoginServerFail("Gameserver registration on ID[3] failed. ID[3] is already in use!", false));
				sendPacket(new LoginServerFail("Free ID[3] or change to another ID, and restart your authserver or gameserver!", false));
			}
		}
