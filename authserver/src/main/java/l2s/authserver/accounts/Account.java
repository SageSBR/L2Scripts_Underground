...
public class Account
{
	...
	public void restore()
	{
		...
		try
		{
			...
			statement = con.prepareStatement("SELECT password, access_level, ban_expire, allow_ip, allow_hwid, bonus, bonus_expire, last_server, last_ip, last_access, points FROM accounts WHERE login = ?");
