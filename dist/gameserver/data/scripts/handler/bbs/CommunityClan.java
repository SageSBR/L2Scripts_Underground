...
public final class CommunityClan extends ScriptsCommunityHandler
{
	...
	protected void doBypassCommand(Player player, String bypass)
	{
		...
		else if("bbsclanlist".equals(cmd))
		{
			...
			String tpl = HtmCache.getInstance().getNotNull("scripts/handler/bbs/bbs_clantpl.htm", player);
		...
		else if("bbsclanadmin".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getNotNull("scripts/handler/bbs/bbs_clanadmin.htm", player);
		...
		else if("mailwritepledgeform".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getNotNull("scripts/handler/bbs/bbs_pledge_mail_write.htm", player);
	...
	private class Listener implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
			...
			{
				String html = HtmCache.getInstance().getNotNull("scripts/handler/bbs/clan_popup.htm", player);
				html = html.replace("%pledge_name%", clan.getName());
