...
public final class CommunityFriends extends ScriptsCommunityHandler
{
	...
	protected void doBypassCommand(Player player, String bypass)
	{
		...
		String html = HtmCache.getInstance().getNotNull(cmd.startsWith("friendbloc") ? "scripts/handler/bbs/bbs_block_list.htm" : "scripts/handler/bbs/bbs_friend_list.htm", player);
	...
	{
		String html = HtmCache.getInstance().getNotNull("scripts/handler/bbs/bbs_block_list.htm", player);
