		...
		switch (player.getRace())
		{
			case ORC:
				if(player.isMageClass())
					Functions.addItem(player, 37321, 1);
				else
					Functions.addItem(player, 37320, 1);
				break;
			case KAMAEL:
				Functions.addItem(player, 37319, 1);
				break;
			case ERTHEIA:
				if(player.isMageClass())
					Functions.addItem(player, 26229, 1);
				else
					Functions.addItem(player, 26230, 1);
				break;
			default:
				if(player.isMageClass())
					Functions.addItem(player, 37316, 1);
				else
				{
					if(player.getClassId().getType2() == ClassType2.WARRIOR)
						Functions.addItem(player, 37315, 1);
					else if(player.getClassId().getType2() == ClassType2.ROGUE || player.getClassId().getType2() == ClassType2.ARCHER)
						Functions.addItem(player, 37318, 1);
					else if(player.getClassId().getType2() == ClassType2.KNIGHT)
						Functions.addItem(player, 37317, 1);
				}
				break;
		}
		return true;
