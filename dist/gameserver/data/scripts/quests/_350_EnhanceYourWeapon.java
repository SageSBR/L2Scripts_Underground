...
public class _350_EnhanceYourWeapon extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		int id = st.getState();
		if(st.getPlayer().getLevel() < 40 || st.getPlayer().getLevel() > 80)
			return "You cannot take this quest since your level is either below 40 or above 80!";
	...
	private void calcAbsorb(List<PlayerResult> players, MonsterInstance npc, AbsorbInfo info)
	{
		...
		for(PlayerResult target : targets)
		{
			...
			if(targetPlayer.consumeItem(soulCrystal.getItemId(), 1, true))
			{
