...
public class _10427_AssassinationOfTheKetraOrcChief extends Quest implements ScriptFile
{
    //Квестовые персонажи
	...
	public _10427_AssassinationOfTheKetraOrcChief()
	{
		...
		addLevelCheck(76, 80);
		addKillId(MOBS);
		addQuestCompletedCheck(_10426_AssassinationOfTheKetraOrcCommander.class);
	}
