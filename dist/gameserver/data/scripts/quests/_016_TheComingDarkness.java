...
public class _016_TheComingDarkness extends Quest implements ScriptFile
{
	...
	public _016_TheComingDarkness()
	{
		...
		addLevelCheck(62);
		addQuestCompletedCheck(_017_LightAndDarkness.class);
	}
	...
	{
		QuestState wd = player.getQuestState(_017_LightAndDarkness.class);
		if(wd == null)
			return false;
		return player.getLevel() >= 62 && wd.isCompleted();
	}
