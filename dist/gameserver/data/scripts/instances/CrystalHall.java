...
public class CrystalHall extends Reflection
{
	...
	private static final int CannonOpenDoor = 19008;//После нее открываем двери TODO разобраться с геодатой этого нпс
	...
	//private Location Сannon8Loc = new Location(149096, 146000, -12369); // y =146872
	private Location СannonOpenDoorLoc = new Location(149768, 145604, -12352);
	...
	NpcInstance can8 = addSpawnWithoutRespawn(CannonOpenDoor, СannonOpenDoorLoc, 0);
	...
	private class DeathListener implements OnDeathListener 
	{
        ...
        public void onDeath(Creature self, Creature killer) 
		{
			...
			else/* if (self.isNpc() && self.getNpcId() == CannonOpenDoor)
			{
				for (Player p : getPlayers())
				{
					p.sendPacket(new ExShowScreenMessage(NpcString.SUCCESSFUL_DESTRUCTION_OF_STRONGHOLD_ENTRY_ACCESSED, 12000, ExShowScreenMessage.ScreenMessageAlign.BOTTOM_CENTER, true, 1, -1, true));
