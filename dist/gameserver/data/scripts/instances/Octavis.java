...
public class Octavis extends Reflection
{
		...
		public void onDeath(Creature actor, Creature killer)
		{
			if(actor.getNpcId() == OCTAVIS_HARD_THIRD)
			{
				for(Player player : getPlayers())
					ItemFunctions.addItem(player, OCTAVIS_SCRYSTAL_ITEM_ID, 1L, true);
			}
		}
	}
	...
	private static final int OCTAVIS_SCRYSTAL_ITEM_ID = 37505;
		...
		switch(status)
		{
			...
			case 2:
			{
				...
				ThreadPoolManager.getInstance().schedule(() ->
				{
					...
					octavis = addSpawnWithoutRespawn(npcId, LAIR_CENTER, 0);
					octavis.addListener(DEATH_LISTENER);
