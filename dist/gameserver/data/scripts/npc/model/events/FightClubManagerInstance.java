...
public class FightClubManagerInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		{
			player.sendPacket(new NpcHtmlMessagePacket(player, this, HtmCache.getInstance().getNotNull(HTML_DISABLED, player), 0));
			return;
		}

		if(command.equalsIgnoreCase("index"))
		{
			player.sendPacket(new NpcHtmlMessagePacket(player, this, HtmCache.getInstance().getNotNull(HTML_INDEX, player), 0));
		}
		...
		{
			player.sendPacket(new NpcHtmlMessagePacket(player, this, HtmCache.getInstance().getNotNull(HTML_INFO, player), 0));
		}
	...
	{
		player.sendPacket(new NpcHtmlMessagePacket(player, this, HtmCache.getInstance().getNotNull(HTML_INDEX, player), val));
	}
