...
public final class NihilInvaderChestInstance extends MonsterInstance
{
	...
	{
		super.reduceCurrentHp(1, attacker, skill, awake, standUp, directHp, canReflectAndAbsorb, transferDamage, isDot, sendReceiveMessage, sendGiveMessage, crit, miss, shld, magic);
	}
