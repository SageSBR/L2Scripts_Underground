...
public final class KartiaHelperInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		{
			Reflection r = player.getActiveReflection(KARTIA_PARTY85);
			if (r != null)
			{
		...
		{
			Reflection r = player.getActiveReflection(KARTIA_PARTY90);
			if (r != null)
			{
		...
		{
			Reflection r = player.getActiveReflection(KARTIA_PARTY95);
			if (r != null)
			{
		...
		{
			Reflection r = player.getActiveReflection(KARTIA_SOLO85);
			if (r != null)
			{
		...
		{
			Reflection r = player.getActiveReflection(KARTIA_SOLO90);
			if (r != null)
			{
		...
		{
			Reflection r = player.getActiveReflection(KARTIA_SOLO95);
			if (r != null)
			{
