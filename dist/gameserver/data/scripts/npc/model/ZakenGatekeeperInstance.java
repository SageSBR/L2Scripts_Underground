...
public final class ZakenGatekeeperInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		{
			Reflection r = player.getActiveReflection(nightZakenIzId);
			if(r != null)
			{
		...
		{
			Reflection r = player.getActiveReflection(dayZakenIzId);
			if(r != null)
			{
		...
		{
			Reflection r = player.getActiveReflection(ultraZakenIzId);
			if(r != null)
			{
