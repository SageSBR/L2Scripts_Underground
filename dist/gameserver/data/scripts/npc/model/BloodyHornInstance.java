...
{
	private static final Skill BLOOD_SACRIFICE_DECREASE_SPEED_1 = SkillHolder.getInstance().getSkill(15537, 1);	// Blood Sacrifice: Decrease Speed (1 lvl.)
	private static final Skill BLOOD_SACRIFICE_DECREASE_SPEED_2 = SkillHolder.getInstance().getSkill(15537, 2);	// Blood Sacrifice: Decrease Speed	(2 lvl.)
	...
	@Override
	public void onCastEndTime(List<Creature> targtes, boolean dual, boolean success)
	{
		super.onCastEndTime(targtes, dual, success);
