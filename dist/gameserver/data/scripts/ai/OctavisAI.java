...
public class OctavisAI extends Fighter
{
  ...
  private final Skill VOLCANO_ZONE = SkillHolder.getInstance().getSkill(14025, 1);
  private final Skill OCTAVIS_POWER1 = SkillHolder.getInstance().getSkill(14028, 1);
  private final Skill OCTAVIS_POWER2 = SkillHolder.getInstance().getSkill(14029, 1);
  private final Skill BEAST_HERO_MOVEMENT = SkillHolder.getInstance().getSkill(14023, 1);
  private final Skill BEAST_ANCIENT_POWER = SkillHolder.getInstance().getSkill(14024, 1);
  private final Skill OCTAVIS_RAIN_OF_ARROWS = SkillHolder.getInstance().getSkill(14285, 1);
